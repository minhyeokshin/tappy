  ...
  <transition name="sidebar-slide">
    <div v-if="showSidebar" class="sidebar-overlay" @click="$emit('closeSidebar')">
      <aside class="sidebar" @click.stop>
        ...
        <nav>
          <ul>
            <li><router-link to="/owner/attendance"><span class="icon">📲</span> 출퇴근</router-link></li>
            <li><router-link to="/owner/worktime"><span class="icon">⏰</span> 근무</router-link></li>
            <li><router-link to="/owner/salary"><span class="icon">💸</span> 급여</router-link></li>
            <li><router-link to="/owner/mypage"><span class="icon">👤</span> 마이</router-link></li>
          </ul>
        </nav>
      </aside>
    </div>
